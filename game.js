...
class RastroDeCores {
    constructor() {
        ...
        // Efeitos Sonoros
        this.sounds = {
            red: new Audio("chicken.mp3"),    // Som de galinha para vermelho
            blue: new Audio("cat.mp3"),       // Som de gato para azul
            green: new Audio("dog.mp3"),      // Som de cachorro para verde
            yellow: new Audio("duck.mp3"),    // Som de pato para amarelo
    ...
    async flashColor(color, isGameSequence = false) {
        ...
        // Tocar som específico da cor
        const sound = this.sounds[color];
        if (sound) {
            sound.currentTime = 0; // Reinicia o som para que possa ser tocado rapidamente
            sound.play();
        }
